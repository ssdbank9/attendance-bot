...
9. A pause may suppress the cloud deadman only with a valid timezone-aware `updated_at` no older than 36 hours.
...
- Pause freshness is set to 36 hours. This bounds a failed-resume blind spot but requires refreshing an intentionally longer pause.
